...
import com.kubeiwu.service.groupimageinfo.OpenGroupImageByIdService;
...
public class OpenGroupImageInfoByIdServlet extends HttpServlet {
	Service service;
	...
	public void init() throws ServletException {
		super.init();
		service = new OpenGroupImageByIdService();
	}
}
